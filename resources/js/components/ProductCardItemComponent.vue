<template>
    <div :class="['c-card', forUseClass, isBuy]">
        ...
        <div class="c-card-content">
            ...
            <p class="c-card-p">賞味期限：{{ this.product.ex_dt }}</p>
            <p class="c-card-p">定価：{{ this.product.price }}円</p>
            <p class="c-card-p">価格：{{ this.product.dis_price }}円</p>
